...
Elaborate on your learnings here in `src/exercise/05.md` Wasn't sure what the
instructions were asking, so looked at solution from this
[Github repo](https://github.com/asheerrizvi/react-fundamentals/blob/main/src/exercise/05.js)
